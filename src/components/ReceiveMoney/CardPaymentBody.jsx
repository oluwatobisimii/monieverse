...
import wallet from "../../assets/icons/WalletNGN.svg";
...
const CardPaymentBody = () => {
  ...
  const [amountSummary, setAmountSummary] = useState(false);
                ...
                {amountSummary && (
                  <div className="flex-1 flex flex-col">
                    <div className="overflow-hidden border border-gray-100 rounded-2xl bg-gray-25">
                      <div className="rounded-2xl px-6 py-4 bg-gray-0 flex justify-between items-center ">
                        <div>
                          ...
                          <div className="h-2" />
                          <p className="text-d-xs lg:text-d-sm font-clashGrotesk font-medium text-gray-600">
                            {num}
                          </p>
                        </div>
                        <div className="flex items-center gap-2 p-1 bg-gray-50 rounded-full pr-2.5">
                    ...
                    <div className="flex justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <p className="text-sm font-medium text-grey-500">
                          {(Number(num) + 20.38).toFixed(2)} NGN
                        </p>
                      </div>
                    ...
                    <div className="flex gap-x-6">
                      ...
                      >
                        {" "}
                        Pay {(Number(num) + 20.38).toFixed(2)} NGN securely
                      </button>
                    </div>
                  </div>
                )}

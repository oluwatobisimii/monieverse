      ...
      <div className="recipientCard bg-gray-0 rounded-3xl w-[437px]">
        ...
        <div className="px-6 py-3 flex gap-4 border-t border-gray-100 justify-between items-center">
          <div className="relative">
            <div
              className="h-10 w-10 center cursor-pointer hover:bg-gray-25 rounded-lg"
              onClick={() => {
                let receiptBtn = document.getElementById("receiptBtn");
                receiptBtn.classList.toggle("hidden");
              }}
            >
              <img src={dots} alt="" />
            </div>
            <div
              className="absolute mt-2 hidden"
              id="receiptBtn"
              onClick={() => {
                setOpenReceipt(true);
                let receiptBtn = document.getElementById("receiptBtn");
            ...
            >
              <div className="flex gap-2 items-center bg-gray-0 p-3 rounded-xl hover:bg-gray-25">
                <FileDotted className="text-primary-500 text-[20px]" />
                <p className="w-fit text-sm md:text-md font-medium whitespace-nowrap">
                  Download Receipt
                </p>
              </div>
            </div>
      ...
      <div className="relative">
        ...
        >
          ...
          setOpenReceipt={setOpenReceipt}
            ...
            accountName={
              transactionsData[currentTransaction]?.accountName || ""
            }
            Bank={Bank}
            editIcon={editIcon}
            calendar={calendar}

          ...
          {step === 2 && (
            ...
            <div className=" lg:rounded-3xl overflow-hidden relative font-inter max-w-[640px] bg-gray-0  flex-1 mx-auto">
              <div className="px-4 pt-10 lg:p-10 relative z-[1]">
                ...
                <div className="h-14" />
                <button
                  className="w-full h-14 bg-primary-400 text-center text-gray-0 text-md font-medium rounded-xl disabled:bg-primary-200 disabled:cursor-not-allowed"
                      ...
                      <button
                        ...
                        onClick={() => {
                          ...
                          let userInput = JSON.parse(
                            sessionStorage.getItem("userInput")
                          );
                ...
                {fillDetails && (
                  <div>
                    ...
                    <div className="flex gap-x-6">
                      ...
                      <button
                        className="flex-1 h-14 bg-primary-400 text-center text-gray-0 text-md font-medium rounded-xl disabled:cursor-wait disabled:bg-primary-200"
                        ...
                        onClick={(e) => {
                          ...
                          dispatch(registerUser(userInput)).then(
                            ({ payload }) => {
